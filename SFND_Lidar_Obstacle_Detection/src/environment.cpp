...
filterCloud = pointProcessor.FilterCloud(inputCloud, 0.25 , Eigen::Vector4f (-10, -5, -2, 1), Eigen::Vector4f ( 25, 7, 2, 1));
...
std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessor.Clustering(segmentCloud.first, 0.5, 10, 300);
